...
static constexpr auto qt_meta_stringdata_CLASSWelcomeWidgetENDCLASS = QtMocHelpers::stringData(
    "WelcomeWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSWelcomeWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSWelcomeWidgetENDCLASS_t qt_meta_stringdata_CLASSWelcomeWidgetENDCLASS = {
    {
