...
set_target_properties(VTK::DICOM PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkDICOM-9.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::CommonMisc;VTK::ImagingCore;VTK::IOCore;VTK::zlib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkDICOM-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::DICOM )
list(APPEND _cmake_import_check_files_for_VTK::DICOM "${_IMPORT_PREFIX}/lib/vtkDICOM-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkDICOM-9.2.dll" )
...
set_target_properties(VTK::ViewsQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::ViewsQt )
list(APPEND _cmake_import_check_files_for_VTK::ViewsQt "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.2.dll" )
...
set_target_properties(VTK::RenderingQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::RenderingQt )
list(APPEND _cmake_import_check_files_for_VTK::RenderingQt "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.2.dll" )
...
set_target_properties(VTK::GUISupportQtSQL PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::vtksys"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtSQL )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtSQL "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.2.dll" )
...
set_target_properties(VTK::GUISupportQtQuick PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQtQuick-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQtQuick-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtQuick )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtQuick "${_IMPORT_PREFIX}/lib/vtkGUISupportQtQuick-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtQuick-9.2.dll" )
...
set_target_properties(VTK::qmlvtkplugin PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qml/Release/VTK.9.2/qmlvtkplugin.dll"
  )

list(APPEND _cmake_import_check_targets VTK::qmlvtkplugin )
list(APPEND _cmake_import_check_files_for_VTK::qmlvtkplugin "${_IMPORT_PREFIX}/lib/qml/Release/VTK.9.2/qmlvtkplugin.dll" )
